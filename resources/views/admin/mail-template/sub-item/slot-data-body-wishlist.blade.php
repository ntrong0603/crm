                        ...
                        <div>
                            <table border="0" cellpadding="1" cellspacing="1" style="width: 100%;">
                                <tbody>
                                                ...
                                                <strong>
                                                    <span style="font-size: 16px;">
                                                        <a rel="nofollow" href="{{ crm_url_product(mb_strtolower($item['model']), $mall, $param) }}" target="_blank">
                                                            <span
                                                                style="color: rgb(0, 0, 255);">{{ $item['name'] }}</span>
                                                        </a>
                                                    </span>
                                                </strong>
                                            </h2>
                                    ...
                                    <tr>
                                        <td style="padding-top: 15px; padding-bottom: 15px; font-size: 18px;">
                                            価格:
                ...
                <tbody>
                    <tr>
                        ...
                        @if (count($productRecommend[$item['model']]) < 3 && ($key + 1) == count($productRecommend[$item['model']]))
                            {{-- Nếu không đủ 3 sản phẩm thì bổ sung thêm thẻ td rổng
                            --}}
